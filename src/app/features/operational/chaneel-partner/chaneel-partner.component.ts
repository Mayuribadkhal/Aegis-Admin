...
@Component({
  selector: 'sa-chaneel-partner',
  templateUrl: './chaneel-partner.component.html',
  styleUrls: ['./chaneel-partner.component.css'],
  animations: [
    trigger('changePane', [
      state('out', style({
        height: 0,
...
export class ChaneelPartnerComponent implements OnInit {
  ...
  public steps = [
    {
      key: 'step1',
      title: 'Channel Partner information',
      valid: true,
      checked: false,
      submitted: false,
